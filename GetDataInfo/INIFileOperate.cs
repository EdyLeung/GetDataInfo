 ...
 public class INIFileOperate
    {
        ...
        /// <param name="fileName">要读取的INI文件</param>
        ...
        #region 在INI文件中指定的节点位置写入对应的内容
        /// <summary>
        ///在INI文件中指定的节点位置写入对应的内容
        /// </summary>
        ...
        public void WriteString(string section, string key, string lpString, string lpFileName)
        {
         WritePrivateProfileString(section, key, lpString, lpFileName);
        }
